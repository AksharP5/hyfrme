...
glass and rim. The screen, avatars, and phone are HTML/CSS. No image assets.
...
composition variables. Each chat's name, message, time, and avatar color is
editable. Avatar initials follow its name. Text is inserted literally, so
...
| `chat1Color` … `chat6Color`                              | CSS avatar colors                                                |
