...
- 284/291 visual ports published in the local verified registry.
- 100/100 animated icons published.
- 37/37 typography/effect ports published.
- 101/101 composition/data ports published.
- 45/45 UI primitive ports published.
- 1/8 standalone visual ports published (`soft-blur-in`, `word-stream`, `word-push`, `sheen-slide-in`, `squeeze-in`, `zoom-words`, `typed-split-wipe`, `rush-type`).
- 7 visual items remain.
