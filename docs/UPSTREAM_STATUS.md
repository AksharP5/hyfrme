...
Pinned Remocn commit: `4ed9b8a3b96396068a17e28e4b3e23f726fcc69d`
...
- 282 registry items
- 276 visual components
- 6 shared runtime libraries
- Families: core 132, icons 100, ui 44

## Verified progress

- 276/276 visual ports published in the local verified registry.
- 100/100 animated icons published.
- 30/30 typography/effect ports published.
- 100/100 composition/data ports published.
...
| --- | ---: |
| interop-or-native-rewrite | 29 |
| manual-review | 34 |
| mechanical-candidate | 213 |
| shared-runtime | 6 |
