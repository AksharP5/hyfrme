...
- 283/291 visual ports published in the local verified registry.
- 100/100 animated icons published.
- 36/36 typography/effect ports published.
- 101/101 composition/data ports published.
- 45/45 UI primitive ports published.
- 1/9 standalone visual ports published (`soft-blur-in`, `word-stream`, `word-push`, `sheen-slide-in`, `squeeze-in`, `zoom-words`, `typed-split-wipe`, `shadow-sweep-text`, `rush-type`).
- 8 visual items remain.
