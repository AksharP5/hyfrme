...
- 285/291 visual ports published in the local verified registry.
- 100/100 animated icons published.
- 38/38 typography/effect ports published.
- 101/101 composition/data ports published.
- 45/45 UI primitive ports published.
- 1/7 standalone visual ports published (`soft-blur-in`, `word-stream`, `word-push`, `squeeze-in`, `zoom-words`, `typed-split-wipe`, `rush-type`).
- 6 visual items remain.
